...
== Criando a VM
Crei o diretório que armazenará as informações da VM:
[source,bash]
----
...
[NOTE]
======
Em sua máquina não há espaço em disco na partição +/+. Você deverá executar o comando acima da seguinte forma:
[source,bash]
----
...
Execute o script vbox a seguir. Ele criará a VM:
[source,bash]
----
